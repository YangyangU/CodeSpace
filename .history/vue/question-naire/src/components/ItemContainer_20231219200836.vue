        ...
        <div v-if="parentComponent==='item'">
            <div class="item_back item_container_style">
                <div class="item_list_container">
                    <header class="item_title">{{ questionList[0].topic_name }}</header>
                    <ul>
                        <li class="item_list" v-for="(item,index) in questionList" :key="index">
                            <span class="option_style">{{ item.topic_name}}</span>
...
import { mapState } from 'vuex';
    export default {
        ...
        computed: mapState(['questionList'])
    }
</script>
...
.home_logo{
    ...
    background-position: right center;//x轴靠右，y轴居中
}
