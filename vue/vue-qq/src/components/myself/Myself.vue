<template>
    <div class="header">
        <div class="small clear">
            ...
            <span>打卡</span>
            <router-link to="./home"><i class="iconfont icon-shanchu2"></i></router-link>
        </div>
        ...
        <div class="wrapper">
            ...
            <div class="name">
                <span class="realName">Dolphin</span>
                <div class="level">
                ...
                <span class="qqNum">路途坎坷，道阻且长</span>
            </div>
            <div class="like">
    ...
    <div class="footer">
        ...
        <div class="child">
            <i class="iconfont icon-a-1djba"></i>
            <span>等级</span>
        </div>
        <div class="child">
